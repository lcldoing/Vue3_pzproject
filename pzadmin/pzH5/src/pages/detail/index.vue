<template>
  <div class="container">
    <div class="header">
        <van-icon @click="goBack" name="arrow-left" class="header-left" size="30"/>订单详情
    </div>
    <statusBar :item="stateMap[detailData.trade_state]"></statusBar>
<div class="tips">
  <div class="dzf" v-if="detailData.trade_state==='待支付'">
    ...
    <div class="text3">
       <van-button @click="showerweima" type="success" >
        立即支付(0.5)元
    </van-button></div>
  </div>
  <div class="dzf" v-if="detailData.trade_state==='待服务'">
    <div class="text1">正在给你安排服务专员</div>

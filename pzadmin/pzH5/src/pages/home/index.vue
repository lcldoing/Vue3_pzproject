<template>
  ...
  <van-swipe class="my-swiper" height="70" :autoplay="3000" indicator-color="white">
...
<van-row justify="space-around">
  <van-col span="11" v-for="(item,index) in homeData.nav2s" :key="item.id" class="center-img" @click="getOrderTwo(index)"> 
      <van-image :src="item.pic_image_url" >
</van-image>
</van-col>
</van-row>

<van-row v-for="item in homeData.hospitals" :key="item.id" class="yy-list" @click="goOrder(item)">
    <van-col span="6" >
        <van-image 
        width="100"
        height="90"
